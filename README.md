...
写的比较急，功能还比较简单，<del>还没写后台和设置，还差删除缓存没做完,你得手动删除下</del><br>
就这样先把,剩下后面慢慢再完善成一个插件<br>

## 安装方法

1. 到 https://github.com/Izumiko/TpHtmlCache 项目中下载最新版本的文件。<br>
2. 将下载的压缩包进行解压，重命名为`TpHtmlCache`,并上传至`Typecho`插件目录中。<br>
3. 后台激活插件。<br>

已测试可用Typecho版本 1.2，PHP >= 8<br>
...
2. <del>因为部分主机问题,去除卸载插件后自动清理缓存</del>
